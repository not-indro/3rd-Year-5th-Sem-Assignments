...
public class circle extends Applet implements ActionListener {
    ...
    public void paint(Graphics g) {
        ...
        int[][] lists = { { 100, 0, 0 }, { 46, 46, 27 }, { 46, 0, -54 }, { 8, 0, 0 }, { 22, 0, 78 }, { 22, 65, -38 },
                { 10, 33, 82 },
                { 10, 88, -14 }, { 10, 54, -70 }, { 5, 50, 80 }, { 6, 94, 3 }, { 6, 45, -83 }, { 4, 58, 76 },
                { 3, 95, 14 },
                { 3, 36, -88 }, { 4, 0, 50 }, { 4, 42, -24 }, { 2, 65, 72 }, { 3, 95, 22 }, { 2, 31, -92 },
                { 4, 23, 92 }, { 4, 91, -30 },
                { 4, 69, -64 } };
